...
from pages.models import Page, PageVersion, PageComment, PageReaction, PageActivity
...
class PageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = [
            ...
            'created_by', 'view_count', 'updated_by'
        ]
...
class PageCommentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PageComment
        fields = '__all__'
        read_only_fields = ['id', 'page', 'workspace', 'created_at', 'updated_at', 'actor']
